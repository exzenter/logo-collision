...
export class TextSplitter {
  ...
  constructor(textElement, options = {}) {
    ...
    // Get SplitType from various possible locations (UMD builds can expose it differently)
    ...
    if (!SplitTypeLib) {
      throw new Error('SplitType library is not available on window. Ensure it is enqueued before textSplitter.');
    }
    this.splitText = new SplitTypeLib(this.textElement, splitOptions);
